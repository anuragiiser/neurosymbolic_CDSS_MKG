# -*- coding: utf-8 -*-
"""MIMIC_3_4_CLRAG_PMKG_SYM_EHR.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ThRW15CTzaUxTesWJ4T0Haz_cV5pi8gx
...
"""## PUBMED RAG (ClinicalRAG of PuMed Articles)

- ### mimic3 symptoms -> PubMedbasedRAG -> Top-n PubMed Articles

- ### mimic4 symptoms -> PubMedbasedRAG -> Top-n PubMed Articles

Two approaches :
1. Only symptoms based querying
2. Both Symptoms + EHR based querying
"""
...
### mimic 3 symptoms + mimic 3 text + PubMed Articles
"""
...
os.makedirs('infer_llm_pubmed_rag_5_mimic_3_sym_note', exist_ok=True)

## MIMIC-3 test set : PUBMED RAG
import gc

def store_preds(test_df, type_ , top_n_docs, output_dir_) :
...
# os.makedirs('infer_llm_pubmed_rag_5_mimic_3_sym_kg_included',exist_ok=True)
...
os.makedirs('infer_llm_pubmed_rag_10_mimic_3_sym_note',exist_ok=True)
...
os.makedirs('infer_llm_pubmed_rag_5_mimic_4_sym')
store_preds(sym_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_5_mimic_4_sym')
get_predictions('infer_llm_pubmed_rag_5_mimic_4_sym', test_set = 'mimic_4')

## sym+EHR  + non-kg

os.makedirs('infer_llm_pubmed_rag_5_mimic_4_sym_note')
store_preds(sym_text_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_5_mimic_4_sym_note')
...
store_preds(sym_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_5_mimic_4_sym_kg_included')
get_predictions('infer_llm_pubmed_rag_5_mimic_4_sym_kg_included', test_set = 'mimic_4')


## Sym + EHR + kg

os.makedirs('infer_llm_pubmed_rag_5_mimic_4_sym_note_kg_included')
store_preds(sym_text_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_5_mimic_4_sym_note_kg_included')
...
os.makedirs('infer_llm_pubmed_rag_10_mimic_4_sym')
store_preds(sym_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_10_mimic_4_sym')
get_predictions('infer_llm_pubmed_rag_10_mimic_4_sym', test_set = 'mimic_4')

## sym+EHR  + non-kg

os.makedirs('infer_llm_pubmed_rag_10_mimic_4_sym_note')
store_preds(sym_text_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_10_mimic_4_sym_note')
...
store_preds(sym_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_10_mimic_4_sym_kg_included')
...
store_preds(sym_text_mim_3, 'kg' , top_n_docs=5, output_dir_= 'infer_llm_pubmed_rag_10_mimic_4_sym_note_kg_included')
