...
tokenizer = AutoTokenizer.from_pretrained("biolink_bert_model")
model = AutoModelForSequenceClassification.from_pretrained("biolink_bert_model", ignore_mismatched_sizes=True)
model.to(device)
