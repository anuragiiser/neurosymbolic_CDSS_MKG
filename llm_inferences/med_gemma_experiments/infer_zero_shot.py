...
def build_prompt(symptoms: str,ehr, k:int) -> str:
    return f"""
...
def predict_icd9(symptoms: str, ehr,k: int=15):
    messages = [
    {
        "role": "system",
    ...
    {
        "role": "user",
        "content": build_prompt(symptoms,ehr,k)
    }
    ]
...
if __name__ == "__main__":
    ...
    for idx, row in enumerate(df.itertuples(), start=0):
        ...
        pred_codes = predict_icd9(row.symptoms,row.text, 15)
